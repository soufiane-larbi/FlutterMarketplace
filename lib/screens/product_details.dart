...
import 'package:jibeex/screens/product_reviews.dart';
import 'package:jibeex/ui_elements/list_product_card.dart';
import 'package:jibeex/ui_elements/mini_product_card.dart';
...
import 'package:jibeex/repositories/wishlist_repository.dart';
...
import 'package:jibeex/helpers/color_helper.dart';
...
import 'package:jibeex/repositories/chat_repository.dart';
import 'package:jibeex/screens/chat.dart';
...
class ProductDetails extends StatefulWidget {
  int id;
  String category;
  ProductDetails({Key key, this.id, this.category = 'N/A'}) : super(key: key);
...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  onWishTap() {
    if (is_logged_in.value == false) {
      ToastComponent.showDialog("Vous devez vous connecter", context,
  ...
  addToCart({mode, context = null, snackbar = null}) async {
    if (is_logged_in.value == false) {
      ToastComponent.showDialog("Vous n'êtes pas connecté", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      Navigator.push(
          context,
          MaterialPageRoute(
  ...
  onPressSendMessage() async {
    ...
    if (title == "" || message == "") {
      ToastComponent.showDialog(
          "Le titre ou le message ne peut pas être vide", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
    ...
    if (conversationCreateResponse.result == false) {
      ToastComponent.showDialog("Impossible de créer la conversation", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            settings:
                                RouteSettings(name: "/Reviews ID:${widget.id}"),
                          )).then((value) {
                        onPopped(value);
                      });
                    },
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            settings: RouteSettings(name: "/Seller Policy"),
                          ));
                    },
                    child: Container(
                      height: 40,
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          ...
                          settings: RouteSettings(name: "/Return Policy"),
                        ),
                      );
                    },
                    child: Container(
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            settings: RouteSettings(name: "/Support Policy"),
                          ));
                    },
                    child: Container(
                      height: 40,
              ...
              SliverList(
                delegate: SliverChildListDelegate([
                  Padding(
                    ...
                    child: Text(
                      "Produits que vous aimerez aussi",
                      style: TextStyle(
                          color: MyTheme.font_grey,
                          fontSize: 16,
                          fontWeight: FontWeight.w600),
          ...
          children: [
            InkWell(
              onTap: () {
                if (is_logged_in.value == false) {
                  ToastComponent.showDialog(
                      "Vous devez vous connecter", context,
                      gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
                  return;
                }
      ...
      actions: <Widget>[
        Padding(
          ...
          child: GestureDetector(
              child: Icon(Icons.share_outlined, color: MyTheme.dark_grey),
              onTap: () {
                SocialShare.shareOptions(_productDetails.link);
              },
              onLongPress: () {
                SocialShare.copyToClipboard(_productDetails.link);
                ToastComponent.showDialog("Copié", context,
            ...
            children: <Widget>[
              Builder(
                builder: (context) {
                  ...
                  return FlatButton(
                    child: Text(
                      !controller.expanded ? "Voir plus" : "Montrer moins",
  ...
  buildTopSellingProductList() {
    if (_topProductInit == false && _topProducts.length == 0) {
      ...
      return Container(
          height: 100,
          child: Center(
              child: Text("Aucun produit le plus vendu de ce vendeur",
                  style: TextStyle(color: MyTheme.font_grey))));
    }
  }
