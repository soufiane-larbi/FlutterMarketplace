...
import 'package:jibeex/repositories/wallet_repository.dart';
import 'package:jibeex/helpers/shimmer_helper.dart';
import 'package:jibeex/custom/toast_component.dart';
import 'package:toast/toast.dart';
import 'package:jibeex/screens/recharge_wallet.dart';
...
class _WalletState extends State<Wallet> {
  ...
  onPressProceed() {
    ...
    if (amount_String == "") {
      ToastComponent.showDialog("Le montant ne peut pas être vide", context,
  ...
  buildRechargeList() {
    if (_rechargeListInit && _rechargeList.length == 0) {
      ...
      return Center(child: Text("Pas encore de recharges"));
    } else {
    ...
    return Column(
      ...
      children: [
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Dernière recharge : ${_balanceDetails.last_recharged}",
                  style: TextStyle(
        ...
        Padding(
          ...
          child: Text(
            "Historique de rechargement du portefeuille",
            style: TextStyle(
