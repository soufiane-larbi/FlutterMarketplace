import 'package:jibeex/screens/seller_products.dart';
  ...
  buildfeaturedProductList() {
    if (_featuredProductInit == false && _featuredProducts.length == 0) {
      ...
      return Container(
          ...
          child: Center(
              child: Text(
                  "Aucun produit vedette n'est disponible chez ce vendeur",
      ...
      onPressed: () {
        Navigator.push(
            ...
            MaterialPageRoute(
              ...
              settings: RouteSettings(name: "/Sellers/${_shopDetails.name}"),
            ));
      },
    );
  }
