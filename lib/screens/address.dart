...
import 'package:jibeex/other_config.dart';
import 'package:jibeex/screens/map_location.dart';
...
class _AddressState extends State<Address> {
    ...
    showDialog(
        ...
        builder: (_) => AlertDialog(
              ...
              content: Padding(
                ...
                child: Text(
                  "Êtes-vous sûr de supprimer cette adresse",
                  maxLines: 3,
  ...
  onAddressAdd(context) async {
    ...
    if (address == "") {
      ToastComponent.showDialog("Entrer l'adresse", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }

    if (_selected_city_name == "") {
      ToastComponent.showDialog("Sélectionnez une ville", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }

    if (_selected_country_name == "") {
      ToastComponent.showDialog("Choisissez un pays", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
                      ...
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              ...
                              settings: RouteSettings(name: '/Map Location'),
                            )).then((value) {
                          onPopped(value);
                        });
                      },
