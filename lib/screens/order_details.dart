  ...
  onPressSubmitRefund(item_id, setState) async {
    ...
    Scaffold.of(context).showSnackBar(SnackBar(
      ...
      action: SnackBarAction(
        label: 'Afficher la liste des demandes',
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                    ...
                    child: Column(
                      ...
                      children: [
                        _orderDetails.shipping_address.name != null
                            ? Text(
                                "Nom: ${_orderDetails.shipping_address.name}",
                                maxLines: 3,
                                style: TextStyle(
                                  color: MyTheme.grey_153,
                                ),
                        ...
                        _orderDetails.shipping_address.email != null
                            ...
                            : Container(),
                        Text(
                          "Addresse: ${_orderDetails.shipping_address.address}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
                        ...
                        Text(
                          "Ville: ${_orderDetails.shipping_address.city}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
                        ...
                        Text(
                          "Pays: ${_orderDetails.shipping_address.country}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
                        ...
                        Text(
                          "Téléphone: ${_orderDetails.shipping_address.phone}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
                        ...
                        Text(
                          "Code postal: ${_orderDetails.shipping_address.postal_code}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
