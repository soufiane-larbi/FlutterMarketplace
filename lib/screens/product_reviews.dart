...
import 'package:jibeex/repositories/review_repositories.dart';
  ...
  onTapReviewSubmit(context) async {
    if (is_logged_in.value == false) {
      ToastComponent.showDialog(
          "Vous devez vous connecter pour donner votre avis", context,
    ...
    //print(chatText);
    if (myReviewText == "") {
      ToastComponent.showDialog("L'avis ne peut pas être vide", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    } else if (_my_rating < 1.0) {
      ToastComponent.showDialog(
          "Au moins une étoile doit être attribuée", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
  ...
  buildProductReviewsList() {
    if (_isInitial && _reviewList.length == 0) {
      ...
      return Container(
        ...
        child: Center(
            child: Text(
                "Pas encore d'avis. Soyez le premier à donner votre avis sur ce produit")),
      );
    } else {
                  ...
                  children: <Widget>[
                    Builder(
                      builder: (context) {
                        ...
                        return FlatButton(
                          child: Text(
                            !controller.expanded ? "Voir plus" : "Voir moins",
                            style: TextStyle(
