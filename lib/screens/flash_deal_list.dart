...
import 'package:jibeex/screens/flash_deal_products.dart';
import 'package:jibeex/repositories/flash_deal_repository.dart';
      ...
      child: CountdownTimer(
        ...
        widgetBuilder: (_, CurrentRemainingTime time) {
          return GestureDetector(
            onTap: () {
              if (time == null) {
                ToastComponent.showDialog("Flashdeal est terminé", context,
                    ...
                    MaterialPageRoute(
                      builder: (context) {
                        return FlashDealProducts(
                          flash_deal_id:
                              flashDealResponse.flash_deals[index].id,
                          flash_deal_name:
