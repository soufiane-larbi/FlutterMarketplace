        ...
        Container(
            ...
            child: ClipRRect(
                borderRadius: BorderRadius.horizontal(
                    left: Radius.circular(5), right: Radius.zero),
                      ...
                      onTap: () {
                        if (categoryResponse
                          ...
                          _scaffoldKey.currentState.showSnackBar(
                            SnackBar(
                              content: Text("Aucune sous-catégorie disponible"),
                            ),
                          );
                        }
                      },
            ...
            Padding(
              ...
              child: Container(
                ...
                child: FlatButton(
                  ...
                  child: Text(
                    "Tous les produits de" + widget.parent_category_name,
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                          ...
                          settings: RouteSettings(
                              name:
                                  "/Categories/${widget.parent_category_name}"),
                        ));
                  },
                ),
              ),
