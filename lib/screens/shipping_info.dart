import 'package:jibeex/screens/checkout.dart';
...
import 'package:jibeex/repositories/address_repositories.dart';
...
class _ShippingInfoState extends State<ShippingInfo> {
  ...
  fetchShippingAddressList() async {
    var addressResponse = await AddressRepository()
        .getAddressList()
  ...
  getSetShippingCost() async {
    var shippingCostResponse = await AddressRepository()
        .getShippingCostResponse(
            widget.owner_id[0], user_id.value, _selected_address_city_name);
            ...
            slivers: [
              SliverList(
                ...
                Padding(
                  ...
                  child: _loadingAddressList == false &&
                          _shippingAddressList.isEmpty
                      ? Container(
                          padding: EdgeInsets.all(8),
                          alignment: Alignment.topCenter,
                          child: Text("Ajoutez une adresse pour continuer"),
                        )
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        "Frais de livraison ${_shipping_cost_string}",
