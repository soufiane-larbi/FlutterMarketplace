...
import 'package:jibeex/data_model/product_details_response.dart';
import 'package:jibeex/data_model/variant_response.dart';
...
class ProductRepository {
  ...
  Future<ProductMiniResponse> getProducts() async {
    final response = await http.get("${AppConfig.BASE_URL}/products");
