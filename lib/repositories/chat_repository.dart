...
import 'package:jibeex/data_model/conversation_response.dart';
import 'package:jibeex/data_model/message_response.dart';
import 'package:jibeex/data_model/conversation_create_response.dart';
...
class ChatRepository {
  ...
  Future<MessageResponse> getInserMessageResponse(
    ...
    final response =
        await http.post("${AppConfig.BASE_URL}/chat/insert-message",
            headers: {
  ...
  Future<ConversationCreateResponse> getCreateConversationResponse(
    ...
    final response =
        await http.post("${AppConfig.BASE_URL}/chat/create-conversation",
            headers: {
              "Content-Type": "application/json",
              "Authorization": "Bearer ${access_token.value}"
            },
