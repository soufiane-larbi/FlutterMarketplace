...
import 'package:jibeex/data_model/profile_image_update_response.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

import 'package:jibeex/data_model/profile_counters_response.dart';
import 'package:jibeex/data_model/profile_update_response.dart';
import 'package:jibeex/data_model/device_token_update_response.dart';
...
class ProfileRepository {
  ...
  Future<DeviceTokenUpdateResponse> getDeviceTokenUpdateResponse(
    ...
    var post_body = jsonEncode(
        {"id": "${user_id.value}", "device_token": "${device_token}"});

    final response =
        await http.post("${AppConfig.BASE_URL}/profile/update-device-token",
            headers: {
              "Content-Type": "application/json",
              "Authorization": "Bearer ${access_token.value}"
            },
